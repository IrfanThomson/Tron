...
def drawScore(score):
    scoreSurf = BASICFONT.render('Red Deaths: %s' % (score), True, RED)
    scoreRect = scoreSurf.get_rect()
    scoreRect.topleft = (WINDOWWIDTH - 400, 10)
    DISPLAYSURF.blit(scoreSurf, scoreRect)

def drawScore2(score):
    scoreSurf2 = BASICFONT.render('Green Deaths: %s' % (score), True, GREEN)
    scoreRect2 = scoreSurf2.get_rect()
    scoreRect2.topleft = (WINDOWWIDTH - 150, 10)
